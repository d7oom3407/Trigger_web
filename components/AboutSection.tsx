        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start mb-24">
          <div className="flex-1">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="glass-card p-8 rounded-3xl border-white/5 bg-violet-600/5">
                   <h3 className="text-lg font-black uppercase italic text-violet-400 mb-3">{t.mission.title}</h3>
          ...
          <div className="lg:w-1/3 w-full">
            <div className="relative group">
              <div className="absolute inset-0 bg-violet-600 blur-[100px] opacity-20 group-hover:opacity-40 transition-opacity"></div>
              <div className="relative aspect-square rounded-[48px] bg-gradient-to-br from-violet-600 via-violet-500 to-indigo-700 flex items-center justify-center shadow-3xl rotate-3 hover:rotate-0 transition-all duration-1000 p-12 border border-white/20">
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {t.values.map((value: any, i: number) => (
              <div key={i} className="glass-card p-10 rounded-[40px] border-white/5 hover:border-violet-500/30 transition-all group">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {t.points.map((point: string, i: number) => (
              <div key={i} className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-violet-500 shadow-[0_0_12px_rgba(139,92,246,1)]"></div>
